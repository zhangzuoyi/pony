...
layui.use(["element", "layer"], function() {
    ...
    i(window).on("resize", function() {
        ...
        a.height(i(this).height() - 145), a.find("iframe").each(function() {
    ...
    i(".layui-nav .layui-nav-item .layui-nav-child dd> a").each(function() {
        ...
        void 0 !== n && l.on("click", function() {
            ...
            if (t.find("li").each(function(a, t) {
                ...
                d += '<i class="layui-icon layui-unselect layui-tab-close">&#x1006;</i>', a.tabAdd("page-tab", {title: d,content: '<iframe src="' + n + '"></iframe>',id: s + 1}), s = t.find("li:last-child").attr("lay-id"), console.log(s);
                ...
                u.find("label").on("click", function() {
                    ...
                    var l = t.find("li.layui-this").find("label").text(), n = e.find("dd.layui-this").find("a").text();
    ...
    i(".user-nav .user-nav-item > a").each(function() {
        var l = i(this), n = l.data("url");
        void 0 !== n && l.on("click", function() {
            var d = l.html(), h = 0, s = t.find("li:last-child").attr("lay-id");
            if (t.find("li").each(function(a, t) {
...
function addTab(title,href){
    ...
    var t = i("#tabTitle"), e = (i("#tabContainer"), i("#sideNav"));
            ...
            var  d= '<label>'+title+'</label>' , h = 0, s = t.find("li:last-child").attr("lay-id");
            if (t.find("li").each(function(a, t) {
                i(this).find("label").text() === title  && (h++, s = i(this).attr("lay-id"))
            }), 0 === h) {
                d += '<i class="layui-icon layui-unselect layui-tab-close">&#x1006;</i>', a.tabAdd("page-tab", {title: d,content: '<iframe src="' + href/*n*/ + '"></iframe>',id: s + 1}), s = t.find("li:last-child").attr("lay-id"), console.log(s);
                var c = i(".layui-tab-content");
                c.find("iframe").each(function() {
                    i(this).height(c.height())
                });
