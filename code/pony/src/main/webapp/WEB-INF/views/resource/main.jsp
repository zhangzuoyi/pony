...
<script type="text/javascript">
 ...
 var app = new Vue({ 
	...
	data : { 		
		...
		resoureTreeUrl : "<s:url value='/resource/listTree'/>",
		parentResoureUrl : "<s:url value='/resource/parentResource'/>",
		updateResoureUrl : "<s:url value='/resource/update'/>",
		deleteResoureUrl : "<s:url value='/resource/delete'/>",
		addResoureUrl : "<s:url value='/resource/add'/>",		
