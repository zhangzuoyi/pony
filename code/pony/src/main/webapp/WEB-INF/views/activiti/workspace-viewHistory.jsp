...
$(function () {
  ...
  $('[data-toggle="popover"]').popover();
    ...
    <script type="text/javascript" src="${tenantPrefix}/static/activiti/replay/scripts/JobExecutor.js"></script>
    <script type="text/javascript" src="${tenantPrefix}/static/activiti/replay/scripts/Node.js"></script>
    <script type="text/javascript" src="${tenantPrefix}/static/activiti/replay/scripts/Token.js"></script>
    <script type="text/javascript" src="${tenantPrefix}/static/activiti/replay/scripts/Replay.js"></script>
    <script type="text/javascript">
REPLAY_TOKEN_IMAGE = '${tenantPrefix}/static/activiti/replay/images/user.png';
//REPLAY_TOKEN_IMAGE = '${tenantPrefix}/static/activiti/replay/images/default.jpg';
