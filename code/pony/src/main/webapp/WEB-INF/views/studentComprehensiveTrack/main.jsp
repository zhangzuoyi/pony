...
var app = new Vue({ 
	...
	data : { 
		...
		conditionVo : {gradeId:null,classId:null,studentId:null,examTypeIds:[]},				
		grades : [],		
		classes:[],		
		students:[],
		examTypes:[],
		...
		listTableDataUrl :"<s:url value='/studentComprehensiveTrack/findByCondition'/>",		
		tableData: [],		
        cols:[]
	...
	methods : { 
		 ...
		 getListTableData:function(){
					...
					if(this.conditionVo.classId==null||this.conditionVo.gradeId==null||this.conditionVo.studentId==null){					
						return ;
						}			 			
