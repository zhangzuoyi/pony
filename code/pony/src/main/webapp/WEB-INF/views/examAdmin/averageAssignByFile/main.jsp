            ...
            <div slot="header" class="clearfix">
                ...
                <el-row>
                    ...
                    <el-col :span="6">
                        ...
                        <el-button type="primary" @click="exportAverageAssignByFile" :disabled="exportFlag">导出
                        </el-button>
                    </el-col>
                </el-row>
            </div>
                ...
                this.$http.post(this.exportResultUrl, formData).then(
                    function (response) {
                        ...
                        if (response.data.name != undefined && response.data.name != null) {
                            ...
                            window.location.href = "<s:url value='/examAdmin/average/exportAssignResultFile?'/>"+jQuery.param(exportParams);
                        }
