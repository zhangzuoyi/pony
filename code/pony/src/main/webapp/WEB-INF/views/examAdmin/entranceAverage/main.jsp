...
var app = new Vue({ 
	...
	data : { 		
		...
		exportResultUrl :"<s:url value='/examAdmin/entranceAverage/exportAverage'/>",
		schoolYear :null,
		term : null,	
	...
	methods : {		
			...
			downloadTemplate : function(){
          	  window.location.href="<s:url value='/examAdmin/entranceAverage/exportTemplate' />";
            },  
                ...
                this.$http.post(this.exportResultUrl,formData).then(
                        function(response){ 
                            ...
                            if (response.data.name != undefined && response.data.name != null) {
                                ...
                                window.location.href = "<s:url value='/examAdmin/entranceAverage/exportAverageFile?'/>"+jQuery.param(exportParams);
                            }
                            });
                return false;           
          },
