  ...
  <div>   	           	
            ...
            <div slot="header" class="clearfix">
              ...
              <el-row>                            
               ...
               <el-button type="primary" @click="addArrangeCombine">新增合班</el-button>
               </el-col>             
              </el-row>
            </div>
            <el-table
...
var app = new Vue({ 
	...
	data : {
		...
		tableData:[],
		listUrl:"<s:url value='/arrangeCombine/list'/>",		
		deleteUrl :"<s:url value='/arrangeCombine/delete'/>",
		addUrl :"<s:url value='/arrangeCombine/add'/>",
	...
	methods : { 
		...
		handleDelete : function(index,row){
			...
			type:'warning'			
			  ...
			  app.$http.get(app.deleteUrl,{params:{combineId:row.combineId}}).then(
					function(response){
						app.getArrangeCombines();
