package org.apache.jsp.WEB_002dINF.views.schoolYear;
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <a href=\"#\" class=\"easyui-linkbutton\" iconCls=\"icon-add\" onclick=\"setCurrent()\" plain=\"true\">设为当前</a>\r\n");
      ...
      out.write("\t\t<input type=\"hidden\" name=\"yearId\" />\r\n");
      out.write("        <table>\r\n");
      out.write("            <tr>\r\n");
      ...
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td align=\"right\">开始日期:</td>\r\n");
      out.write("                <td><input type=\"text\" name=\"startDate\" class=\"my-text easyui-datebox\" data-options=\"formatter:myformatter,parser:myparser\" /></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            <tr>\r\n");
      out.write("                <td align=\"right\">结束日期:</td>\r\n");
      out.write("                <td><input type=\"text\" name=\"endDate\" class=\"my-text easyui-datebox\" data-options=\"formatter:myformatter,parser:myparser\" /></td>\r\n");
      out.write("            </tr>\r\n");
      out.write("        </table>\r\n");
      out.write("    </form>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction setCurrent(){\r\n");
      out.write("\t\t$.messager.confirm('信息提示','确定要设置为当前学年吗？', function(result){\r\n");
      out.write("\t\t\tif(result){\r\n");
      out.write("\t\t\t\tvar item = $('#my-datagrid-2').datagrid('getSelected');\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl:\"");
      ...
      out.write("\t\t\t\t\tsuccess:function(data){\r\n");
      out.write("\t\t\t\t\t\tif(data){\r\n");
      out.write("\t\t\t\t\t\t\t$.messager.alert('信息提示','设置当前成功！','info');\t\t\r\n");
      out.write("\t\t\t\t\t\t\t reload();\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\telse\r\n");
      out.write("\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t$.messager.alert('信息提示','设置当前失败！','info');\t\t\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}\t\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\t\r\n");
      ...
      out.write("\t\t\t{ field:'yearId',title:'ID',width:100,sortable:true},\r\n");
      out.write("\t\t\t{ field:'name',title:'名称',width:180,sortable:true},\r\n");
      out.write("\t\t\t{ field:'startDate',title:'开始日期',width:100},\r\n");
      out.write("\t\t\t{ field:'endDate',title:'结束日期',width:100},\r\n");
      out.write("\t\t\t{ field:'isCurrent',title:'是否当前',width:180,sortable:true,\r\n");
      out.write("\t\t\t\tformatter:function(value,rec){\r\n");
      out.write("\t\t\t\t\tif(rec.isCurrent == '0'){\r\n");
      out.write("\t\t\t\t\t\treturn \"是\";\r\n");
      out.write("\t\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\t\treturn \"否\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
  ...
  private boolean _jspx_meth_s_url_7(PageContext _jspx_page_context)
    ...
    _jspx_th_s_url_7.setValue("/schoolYear/add");
  ...
  private boolean _jspx_meth_s_url_8(PageContext _jspx_page_context)
    ...
    _jspx_th_s_url_8.setValue("/schoolYear/edit");
  ...
  private boolean _jspx_meth_s_url_9(PageContext _jspx_page_context)
    ...
    _jspx_th_s_url_9.setValue("/schoolYear/delete");
  ...
  private boolean _jspx_meth_s_url_10(PageContext _jspx_page_context)
    ...
    _jspx_th_s_url_10.setValue("/schoolYear/setCurrent");
  ...
  private boolean _jspx_meth_s_url_11(PageContext _jspx_page_context)
    ...
    _jspx_th_s_url_11.setValue("/schoolYear/get");
  ...
  private boolean _jspx_meth_s_url_12(PageContext _jspx_page_context)
    ...
    _jspx_th_s_url_12.setValue("/schoolYear/list");
