...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </form>\r\n");
      out.write("</div>\r\n");
      out.write("<div id=\"my-dialog-3\" class=\"easyui-dialog\" data-options=\"closed:true,iconCls:'icon-save',title:'成绩分析'\" style=\"width:800px; padding:10px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\tmydata[i]={};\r\n");
      out.write("\t\t\t\t\t\tvar item=data[i];\r\n");
      out.write("\t\t\t\t\t\tnames[i]=item.studentName;\r\n");
      out.write("\t\t\t\t\t\tmydata[i]=item.score;\r\n");
      out.write("\t\t\t\t\t}\r\n");
